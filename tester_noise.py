...
parser.add_argument("--degset", default="/kaggle/input/kodak24-50/Kodak24/degraded/", type=str, help="degraded data")
parser.add_argument("--tarset", default="/kaggle/input/kodak24-50/Kodak24/degraded/", type=str, help="target data")
