...
parser.add_argument("--save", default="/kaggle/working/results/noise/OUT/kodak/50/", type=str, help="savepath, Default: results")
parser.add_argument("--savetar", default="/kaggle/working/results/noise/TAR/kodak/", type=str, help="savepath, Default: targets")
parser.add_argument("--saveres", default="/kaggle/working/results/noise/RES/", type=str, help="savepath, Default: residual")
